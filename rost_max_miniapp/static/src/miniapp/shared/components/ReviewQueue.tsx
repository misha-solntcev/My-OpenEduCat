 ...
 * Сегмент «Сдано / На доработке / Проверено» — рабочие фильтры: каждый
 * показывает свой список; сдача из «Сдано» раскрыта (ответ, вложения,
          ...
          return (
            <React.Fragment key={s.student_id}>
              ...
              >
                ...
                {s.state === 'submit' && <span style={grayPill}>Сдано</span>}
